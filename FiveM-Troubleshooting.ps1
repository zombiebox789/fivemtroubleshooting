...
#region Config#Requires -Version 5.1
<#
.SYNOPSIS
    FiveM Troubleshooter v2.5.6
...
function Connect-WeThePeopleRP {
    ...
    Write-Log "Launching FiveM connection via user shell: We The People RP" "ACTION"

    try {
        # When this script is elevated, launching URI directly can fail.
        # Delegating to Explorer uses the interactive user shell.
        ...
        Write-Log "Explorer launch failed, trying direct URI launch: $($_.Exception.Message)" "WARN"
    }
    ...
    try {
        ...
        throw "Failed to open FiveM connection URI. Ensure FiveM is installed and fivem:// protocol is registered."
    }
}
