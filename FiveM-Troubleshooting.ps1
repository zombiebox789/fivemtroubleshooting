...
function Show-ActionHistoryWindow {
    $historyForm = New-Object System.Windows.Forms.Form
    $historyForm.Text = "Action History"
    $historyForm.StartPosition = "CenterParent"
    $historyForm.Size = New-Object System.Drawing.Size(900,500)
    $historyForm.BackColor = [System.Drawing.Color]::FromArgb(18,18,24)
    $historyForm.ForeColor = [System.Drawing.Color]::White

    $grid = New-Object System.Windows.Forms.DataGridView
    $grid.Dock = 'Fill'
    $grid.BackgroundColor = [System.Drawing.Color]::FromArgb(24,24,32)
    $grid.ForeColor = [System.Drawing.Color]::White
    $grid.BorderStyle = 'None'
    $grid.AutoSizeColumnsMode = 'Fill'
    $grid.DataSource = @($Script:History)
    $historyForm.Controls.Add($grid)

    [void]$historyForm.ShowDialog($Script:MainForm)
}
...
function Show-MainWindow {
    ...
    $buttons = @(
        ...
        @{T='Action History'; A={ param($btn) Show-ActionHistoryWindow }},
